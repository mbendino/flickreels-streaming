      ...
      <div className="max-w-md mx-auto px-4">
        <div className="sticky top-0 z-10 bg-zinc-950 pb-4">
          <div className="relative">
            ...
            <input type="text" value={query} onChange={(e) => setQuery(e.target.value)} placeholder="Search dramas..." className="w-full bg-zinc-900 text-white pl-10 pr-4 py-3 rounded-lg focus:outline-none focus:ring-2 focus:ring-red-500" autoFocus />
          </div>
        </div>
